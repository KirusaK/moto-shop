...
<body>
    ...
    <div class="wrapper char">
        <div class="towar">
            ...
            <div class="dane1">
                <h2>MAGNETI MARELLI Żarówka, reflektor dalekosiężny</h2>
                <p>Nr artykułu: 123345</p>
                <h2>7,75 zl</h2>
                <form class="add-to-cart-form" method="post">
                    <input type="hidden" name="article" value="123345">
                    <input type="hidden" name="name" value="MAGNETI MARELLI Żarówka, reflektor dalekosiężny">
                    <input type="hidden" name="price" value="7,75">
                    <input type="hidden" name="image" value="../img/zarowka1.jpg">
        ...
        <div class="op">
            ...
            <div class="opis">
                <h4>Opis</h4>
                <p>Żarówki reflektorów dalekosiężnych MAGNETI MARELLI 
                    to wysokiej jakości komponenty oświetleniowe, 
                    które zapewniają doskonałą widoczność i bezpieczeństwo na drodze. 
                    Produkowane przez renomowaną włoską firmę, 
                    są dostępne w różnych typach, 
                    w tym halogenowych i ksenonowych, 
                    pasujących do wielu modeli samochodów.
                </p>
            </div>
        </div>
        <hr>
