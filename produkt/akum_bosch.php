...
<body>
    ...
    <div class="wrapper char">
        <div class="towar">
            ...
            <div class="dane">
                <h2>BOSCH S3 002 Akumulato</h2>
                <p>Nr artykułu: 205827</p>
                <h2>280,52 zl</h2>

                <form class="add-to-cart-form" method="post">
                    <input type="hidden" name="article" value="205827">
                    <input type="hidden" name="name" value="BOSCH S3 002 Akumulato">
                    <input type="hidden" name="price" value="280,52">
                    <input type="hidden" name="image" value="../img/akumulator3.jpg">
        ...
        <div class="op">
            ...
            <div class="opis">
                <h4>Opis</h4>
                <p>Akumulator BOSCH S3 002 jest produkowany w Niemczech i 
                    stanowi doskonały wybór do samochodów z minimalnym wyposażeniem elektrycznym. 
                    Charakteryzuje się niezawodnością i dobrymi parametrami rozruchowymi, 
                    zapewniając stabilną pracę nawet w trudnych warunkach pogodowych.
                </p>
            </div>
        </div>
        <hr>
        ...
        <div class="podobne">
            <div class="block">
                ...
                <button type="button" onclick="location.href='akum_maxgear.php'">450,53 zl</button>
            </div>
            <div class="block">
