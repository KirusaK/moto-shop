...
<body>
    ...
    <div class="wrapper char">
        <div class="towar">
            ...
            <div class="dane1">
                <h2>VAN WEZEL Maska silnika odpowiednie do MERCEDES-BENZ Klasa A </h2>
                <p>Numer artykułu: 035933</p>
                <h2>2774,74 zl</h2>
                <form class="add-to-cart-form" method="post">
                    <input type="hidden" name="article" value="035933">
                    <input type="hidden" name="name" value="VAN WEZEL Maska silnika odpowiednie do MERCEDES-BENZ Klasa A">
                    <input type="hidden" name="price" value="2774,74">
                    <input type="hidden" name="image" value="../img/nadwozie1.jpg">
        ...
        <div class="op">
            ...
            <div class="opis">
                <h4>Opis</h4>
                <p>Firma VAN WEZEL produkuje maski silnika do różnych modeli samochodów, 
                    w tym do Mercedes-Benz Klasa A. 
                    Produkcja tych części odbywa się głównie w Belgii, 
                    gdzie firma zapewnia wysoką jakość swoich produktów.
                </p>
            </div>
        </div>
        <hr>
        ...
        <div class="podobne">
            <div class="block">
                ...
                <p>VAN WEZEL Zderzak odpowiednie do OPEL ASTRA</p>
                <button type="button" onclick="location.href='nadwozie_vanwezel2.php'">576,81 zl</button>
            </div>
            <div class="block">
