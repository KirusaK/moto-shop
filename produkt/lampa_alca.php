...
<body>
    ...
    <div class="wrapper char">
        <div class="towar">
            ...
            <div class="dane1">
                <h2>ALCA Żarówka, reflektor dalekosiężny</h2>
                <p>Nr artykułu: 257976</p>
                <h2>10,05 zl</h2>
                <form class="add-to-cart-form" method="post">
                    <input type="hidden" name="article" value="257976">
                    <input type="hidden" name="name" value="ALCA Żarówka, reflektor dalekosiężny">
                    <input type="hidden" name="price" value="10,05">
                    <input type="hidden" name="image" value="../img/zarowka3.jpg">
        ...
        <div class="op">
            ...
            <div class="opis">
                <h4>Opis</h4>
                <p>Żarówki ALCA do reflektorów dalekosiężnych oferują dobrą jakość oświetlenia przy przystępnej cenie. 
                    Dzięki różnorodnym typom, takim jak H1, H4, H7, czy H11, 
                    można je dopasować do wielu modeli samochodów, 
                    zapewniając odpowiednią widoczność i bezpieczeństwo na drodze.
                </p>
            </div>
        </div>
        <hr>
        ...
        <div class="podobne">
            ...
            <div class="block">
                ...
                <p>BOSCH Żarówka, reflektor dalekosiężny </p>
                <button type="button" onclick="location.href='lampa_bosch.php'">7,29 zl</button>
            </div>
        </div>
    </div>
