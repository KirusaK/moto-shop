...
<body>
    ...
    <div class="wrapper char">
        <div class="towar">
            ...
            <div class="dane">
                <h2>BREMBO P 78 020X Klocki hamulcowe</h2>
                <p>Numer artykułu: 028858</p>
                <h2>187,41 zl</h2>
                <form class="add-to-cart-form" method="post">
                    <input type="hidden" name="article" value="028858">
                    <input type="hidden" name="name" value="BREMBO P 78 020X Klocki hamulcowe">
                    <input type="hidden" name="price" value="187,41">
                    <input type="hidden" name="image" value="../img/h-preview1.jpg">
        ...
        <div class="op">
            ...
            <div class="opis">
                <h4>Opis</h4>
                <p>Klocki hamulcowe Brembo P 78 020X 
                    są przeznaczone do samochodów wymagających wysokiej wydajności i bezpieczeństwa. 
                    Zapewniają doskonałą efektywność hamowania, 
                    niski poziom hałasu oraz długowieczność, 
                    a także spełniają europejskie normy bezpieczeństwa ECE-R90.
                </p>
            </div>
        </div>
        <hr>
