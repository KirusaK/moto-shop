...
<body>
    ...
    <div class="wrapper char">
        <div class="towar">
            ...
            <div class="dane1">
                <h2>BLIC Zderzak odpowiednie do OPEL ASTRA </h2>
                <p>Nr artykułu: 142474</p>
                <h2>208 zl</h2>
                <form class="add-to-cart-form" method="post">
                    <input type="hidden" name="article" value="142474">
                    <input type="hidden" name="name" value="BLIC Zderzak odpowiednie do OPEL ASTRA">
                    <input type="hidden" name="price" value="208">
                    <input type="hidden" name="image" value="../img/nadwozie3.jpg">
        ...
        <div class="op">
            ...
            <div class="opis">
                <h4>Opis</h4>
                <p>Firma BLIC produkuje zderzaki do różnych modeli samochodów, 
                    w tym do Opel Astra. 
                    Produkty tej firmy są wytwarzane w Polsce, 
                    charakteryzując się dobrą jakością i atrakcyjną ceną.
                </p>
            </div>
        </div>
        <hr>
