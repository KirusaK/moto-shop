    ...
    <div class=" wrapper2 box1">
        ...
        <div class="olej1">
            <div class="left-column">
                <div class="blockk2">
                    <h3>Marka</h3>
                    <form id="filter-form" method="POST" action="to.php">

                        <div class="char brand-filter">
                            <input type="checkbox" id="liqui" name="brand" value="LIQUI MOLY" class="ol">
                            <label for="LIQUI MOLY">LIQUI MOLY</label>
                            <input type="checkbox" id="shell" name="brand" value="SHELL" class="ol">
                            <label for="SHELL">SHELL</label>
                            <input type="checkbox" id="opel" name="brand" value="OPEL GM" class="ol">
                            ...
                            <input type="checkbox" id="magneti" name="brand" value="MAGNETI MARELLI" class="ol">
                            ...
                            <input type="checkbox" id="van" name="brand" value="VAN WEZEL" class="ol">
